...
SERVER_VERSION = "cloud-app-crop-v38"
...
async def read_passport_fields(
    ...
    if enhanced_data:
        ...
        for key in ("given_name_en", "surname_en", "father_name_en", "passport_number"):
            if not printed.get(key) and enhanced_printed.get(key):
                printed[key] = enhanced_printed[key]
    ...
    result.update({
        "success": True,
        "mode": "pak_label_rescue_v38",
        "client_crop_mode": client_crop_mode or "pak_label_rescue_v38",
        "server_version": SERVER_VERSION,
        "ocr_time_ms": elapsed_ms,
